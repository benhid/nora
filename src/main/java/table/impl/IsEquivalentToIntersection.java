...
public class IsEquivalentToIntersection extends CassandraTable {

    public IsEquivalentToIntersection(Database database) {
        super("IsEquivalentToIntersection", database);
    ...
    public static class Row implements Serializable {
        ...
        public String toString() {
            return MessageFormat.format("IsEquivalentToClass'{'cls={0}, num=''{1}'', ind1={2}, ind2={3}'}'", cls, num, ind1, ind2);
        }
