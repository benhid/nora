...
public class IsSubclassOfUnion extends CassandraTable {

    public IsSubclassOfUnion(Database database) {
        super("IsSubclassOfUnion", database);
    ...
    public static class Row implements Serializable {
        ...
        public String toString() {
            return MessageFormat.format("IsSubclassOfUnion'{'cls={0}, num=''{1}'', ind1={2}, ind2={3}'}'", cls, num, ind1, ind2);
        }
    }
