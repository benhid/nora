...
public class IsSubclassOfIntersection extends CassandraTable {

    public IsSubclassOfIntersection(Database database) {
        super("IsSubclassOfIntersection", database);
    ...
    public static class Row implements Serializable {
        ...
        public String toString() {
            return MessageFormat.format("IsSubclassOfIntersection'{'cls={0}, num=''{1}'', ind1={2}, ind2={3}'}'", cls, num, ind1, ind2);
        }
    }
