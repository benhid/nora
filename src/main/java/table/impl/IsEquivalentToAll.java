...
public class IsEquivalentToAll extends CassandraTable {

    public IsEquivalentToAll(Database database) {
        super("IsEquivalentToAll", database);
    ...
    public static class Row implements Serializable {
        ...
        public String toString() {
            return MessageFormat.format("IsEquivalentToAll'{'cls={0}, num=''{1}'', prop={2}, range={3}'}'", cls, num, prop, range);
        }
    }
