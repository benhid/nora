...
public class IsEquivalentToMaxCardinality extends CassandraTable {

    public IsEquivalentToMaxCardinality(Database database) {
        super("IsEquivalentToMaxCardinality", database);
    ...
    public static class Row implements Serializable {
        ...
        public String toString() {
            return MessageFormat.format("IsEquivalentToMaxCardinality'{'cls={0}, num=''{1}'', prop={2}, card={3}, clss={4}'}'", cls, num, prop, card, clss);
        }
