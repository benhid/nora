...
public class IsSubclassOfMaxCardinality extends CassandraTable {

    public IsSubclassOfMaxCardinality(Database database) {
        super("IsSubclassOfMaxCardinality", database);
    ...
    public static class Row implements Serializable {
        ...
        public String toString() {
            return MessageFormat.format("IsSubclassOfMaxCardinality'{'cls={0}, num=''{1}'', prop={2}, card={3}, clss={4}'}'", cls, num, prop, card, clss);
        }
