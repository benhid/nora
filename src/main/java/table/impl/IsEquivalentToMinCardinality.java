...
public class IsEquivalentToMinCardinality extends CassandraTable {

    public IsEquivalentToMinCardinality(Database database) {
        super("IsEquivalentToMinCardinality", database);
    ...
    public static class Row implements Serializable {
        ...
        public String toString() {
            return MessageFormat.format("IsEquivalentToMinCardinality'{'cls={0}, num=''{1}'', prop={2}, card={3}, clss={4}'}'", cls, num, prop, card, clss);
        }
