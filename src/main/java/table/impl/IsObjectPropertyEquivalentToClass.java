...
public class IsObjectPropertyEquivalentToClass extends CassandraTable {

    public IsObjectPropertyEquivalentToClass(Database database) {
        super("IsObjectPropertyEquivalentToClass", database);
    ...
    public static class Row implements Serializable {
        ...
        public String toString() {
            return MessageFormat.format("IsObjectPropertyEquivalentToClass'{'cls={0}, num=''{1}'', equiv={2}'}'", cls, num, equiv);
        }
