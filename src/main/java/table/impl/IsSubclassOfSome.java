...
public class IsSubclassOfSome extends CassandraTable {

    public IsSubclassOfSome(Database database) {
        super("IsSubclassOfSome", database);
    ...
    public static class Row implements Serializable {
        ...
        public String toString() {
            return MessageFormat.format("IsSubclassOfSome'{'cls={0}, num=''{1}'', prop={2}, range={3}'}'", cls, num, prop, range);
        }
    }
