...
public class IsSubclassOfAll extends CassandraTable {

    public IsSubclassOfAll(Database database) {
        super("IsSubclassOfAll", database);
    ...
    public static class Row implements Serializable {
        ...
        public String toString() {
            return MessageFormat.format("IsSubclassOfAll'{'cls={0}, num=''{1}'', prop={2}, range={3}'}'", cls, num, prop, range);
        }
    }
